...
public class NepaliDateConverter : INepaliDateConverter
{
    ...
    {
        var calendar = Converters.DateConverter.ConvertToNepali(adDate.Year, adDate.Month, adDate.Day);
    ...
    public string GetBsDateFromAdDate(int yy, int mm, int dd, char separator = '-', string format = "yyyy-mm-dd")
    {
        ...
        var calendar = Converters.DateConverter.ConvertToNepali(yy, mm, dd);
    ...
    public DateTime GetAdDateFromBsDate(string bsDate, char separator = '-')
    {
        ...
        var calendar = Converters.DateConverter.ConvertToEnglish(year, month, day);
